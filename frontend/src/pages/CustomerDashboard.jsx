...
return ( <div className="min-h-screen bg-[#01263B] text-white p-8">
    ...
    <div className="bg-[#0A3A55] p-6 rounded-xl mb-8 flex justify-between items-center">
      ...
      <div className="relative">
        ...
        <img
          ...
          alt="Bike"
          className="w-[420px] rounded-2xl object-contain"
        />
  ...
  {loadingBookings ? (
    ...
    <table className="min-w-full bg-white text-black rounded-3xl overflow-hidden">
      <thead className="bg-gray-100 text-3xl font-bold">
        <tr>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Booking Ref</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Part</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Date</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Time</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Status</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Action</th>
        </tr>
      </thead>
  ...
  {loadingJobs ? (
    ...
    <table className="min-w-full bg-white text-black rounded-3xl overflow-hidden text-3xl font-medium">
      ...
      <thead className="bg-gray-100">
        <tr>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Job Card #</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Vehicle</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Service Type</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Odometer</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Voltage</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Status</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Created</th>
          <th className="py-6 px-4 text-left text-5xl font-extrabold">Action</th>
        </tr>
      </thead>
